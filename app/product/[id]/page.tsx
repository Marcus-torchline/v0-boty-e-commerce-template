...
export default function ProductPage() {
  ...
  },
  {
    ...
    title: 'How to Use',
    content:
      PRODUCT_COPY[product?.id ?? '']?.howToUse ??
      'Slide the sleeves onto your upper arms and secure with the adjustable velcro straps. Wear for 1-2 hours daily while walking, cooking, watching TV, or doing light activities. For best results, combine with the exercises in our Toned Arms After 40 guide. Hand wash with mild soap and air dry.',
  },
  {
    key: 'shipping',
    title: 'Shipping & Returns',
    content:
      PRODUCT_COPY[product?.id ?? '']?.shipping ??
      'Free standard shipping on orders over $50. Express shipping available at checkout. All orders ship within 1-2 business days. We offer a 30-day money-back guarantee - if you are not satisfied with your results, return the product for a full refund.',
  },
  ]
