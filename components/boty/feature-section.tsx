...
export function FeatureSection() {
  ...
  return (
    <section className="bg-background">
      ...
      {/* ── 5. Simple Technology. Honest Results. ── */}
      <div className="py-16 bg-card">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            {[
              {
                ...
                description: "Applies light, even pressure that supports healthy blood flow and helps reduce fluid retention naturally.",
              },
              {
                icon: Flame,
                title: "Thermal Activation",
                description: "A subtle warming layer works with your body heat to smooth and firm areas where skin tends to lose definition with age.",
              },
              {
                icon: Timer,
                title: "Visible Results",
                description: "Most women notice a difference in 30 to 45 days of consistent daily wear, no extreme routines required.",
              },
            ].map((pillar, i) => (
              <div
                key={pillar.title}
